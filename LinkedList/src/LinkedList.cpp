...
void LinkedList::Append(Bid bid) {
	...
	Node *node = new Node(bid); // @suppress("Type cannot be resolved") - Problem
...
void LinkedList::PrintList() {
	...
	Node *current = head;
		...
		//Loop over all nodes looking for a match
...
void LinkedList::Remove(string bidId) {
	...
	// loop over each node looking for a match
	    while (current->next != nullptr) {
	        // if the next node beyond current is a match
